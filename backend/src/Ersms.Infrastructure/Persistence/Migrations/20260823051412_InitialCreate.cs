        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdentifyingDetails = table.Column<string>(type: "text", nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Name = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    BusinessInfo = table.Column<string>(type: "text", nullable: true),
                    Status = table.Column<string>(type: "text", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RepairStatusDefinitions", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RepairNumber = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: false),
                    CustomerId = table.Column<Guid>(type: "uuid", nullable: false),
                    DeviceId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Repairs_RepairStatusDefinitions_StatusId",
                        column: x => x.StatusId,
                        principalTable: "RepairStatusDefinitions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RepairServiceLines", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RepairServiceLines_Repairs_RepairId",
                        column: x => x.RepairId,
                        principalTable: "Repairs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppRoles_OrganizationId_Code",
                table: "AppRoles",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Devices_OrganizationId_Imei",
                table: "Devices",
                columns: new[] { "OrganizationId", "Imei" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Repairs_OrganizationId_CustomerId",
                table: "Repairs",
                columns: new[] { "OrganizationId", "CustomerId" });

            migrationBuilder.CreateIndex(
                name: "IX_Repairs_OrganizationId_DeviceId",
                table: "Repairs",
                columns: new[] { "OrganizationId", "DeviceId" });

            migrationBuilder.CreateIndex(
                name: "IX_Repairs_OrganizationId_RepairNumber",
                table: "Repairs",
                columns: new[] { "OrganizationId", "RepairNumber" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RepairServiceLines_RepairId",
                table: "RepairServiceLines",
                column: "RepairId");

            migrationBuilder.CreateIndex(
                name: "IX_RepairStatusDefinitions_OrganizationId_Code",
                table: "RepairStatusDefinitions",
                columns: new[] { "OrganizationId", "Code" },
                unique: true);
